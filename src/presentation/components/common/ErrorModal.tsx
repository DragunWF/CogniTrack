...
/**
 * ErrorModal - Simple error display modal
 *
 * Displays error messages to the user with a single dismiss button.
 * Used for displaying API errors, validation errors, etc.
 *
